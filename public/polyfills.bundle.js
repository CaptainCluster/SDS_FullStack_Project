...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(35)(Function.call, __webpack_require__(28).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// @@match logic
__webpack_require__(52)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(52)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
// @@search logic
__webpack_require__(52)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
// @@split logic
__webpack_require__(52)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(21)(proto, TO_PRIMITIVE, __webpack_require__(198));
...
$export($export.S, 'Math', { fround: __webpack_require__(202) });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(67), __webpack_require__(330)))
